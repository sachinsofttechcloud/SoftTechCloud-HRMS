// SVG Icon Components for SoftTechCloud HRMS (100% SVG, Deployment-safe)
...
export const EyeOffIcon = (p) => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <path d="M9.9 4.2A10.9 10.9 0 0 1 12 4c6.5 0 10 8 10 8a18 18 0 0 1-2.2 3.2M6.6 6.6A18 18 0 0 0 2 12s3.5 8 10 8a10.9 10.9 0 0 0 5.4-1.4" />
...
export const ManageUsersIcon = (p) => (
  ...
  >
    ...
    <path d="M18 14.5c1.8.7 3 2.4 3 4.5" />
